...
func (c *DamConnection) FetchAssetById(id int) (AssetEntity, error) {
...
func (c *DamConnection) FetchAssetDatapointCollection(id int) ([]DatapointEntity, error) {
    var datapoints []DatapointEntity
